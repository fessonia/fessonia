  ...
  _validateOptions (options) {
    ...
    if (!info) {
      if (config.log_warnings) {
        console.warn(`FilterNode ${util.inspect(this)} options object specifies unknown value for 'filterName' property. Please ensure that your FFmpeg installation understands the filter name. You can see what filters FFmpeg knows about with: ffmpeg -filters`);
      }
    }
    if (info) {
      let pads;
