...
class FilterNode {
   ...
   * 
   * @returns {string} - a value from FFmpegEnumerations.FilterCommands
   */
  static _getFilterCommand (ffmpegFilter) {
    ...
    // set filter I/O type
    if (isComplex) { return FFmpegEnumerations.FilterCommands.COMPLEX; }
    return FFmpegEnumerations.FilterCommands.FILTER;
  }
